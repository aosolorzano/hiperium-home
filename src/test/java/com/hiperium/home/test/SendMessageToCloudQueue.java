 ...
 * 
 */
public class SendMessageToCloudQueue {

	/** The LOGGER property for logger messages. */
	private static final Logger LOGGER = Logger.getLogger(SendMessageToCloudQueue.class);
	...
	public static void main(String[] args) {
        ...
        try {
	        ...
	        Queue queue = HornetQJMSClient.createQueue("deviceQueue");
